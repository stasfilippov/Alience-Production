...
<html lang="en">
    <head>
        ...
        <title>О компании - Alience Production</title>
    </head>
    <body>
        ...
        <header class="header header-inner-page">
            <div class="header-inner-page-content">
                <div class="container">
                    <div class="seporator"></div>
                    <h1 class="header-inner-page-title">о компании</h1>
                    ...
                    <!-- <img src="/image/avto-him.png" alt="avto-him" class="header-inner-page-image"> -->
                </div>
            </div>
        </header>
        <header class="header header-inner-page-i">
            <div class="container">
                <div class="header-inner-page-content">
                    <div class="seporator"></div>
                    <h1 class="header-inner-page-title">о компании</h1>
        ...
        <header class="header header-inner-page-bg ">
            <div class="header-inner-page-wrapper">
                <img src="/image/bg-inner-page.jpg" alt="background" class="bg-inner-page">
                <div class="container">
                    <div class="header-inner-page-content">
                        <div class="seporator"></div>
                        <h1 class="header-inner-page-title light">о компании</h1>
                        <ol class="breadcrambs" itemscope itemtype="https://schema.org/BreadcrumbList">
                            <li class="breadcrambs-item light" itemprop="itemListElement" itemscope
                            itemtype="https://schema.org/ListItem">
                                <a href="./" class="breadcrambs-link" itemprop="item">
                                    <span itemprop="name">Главная</span>
                                </a>
                            ...
                            <li class="breadcrambs-item light"
                            itemprop="itemListElement" itemscope
                            itemtype="https://schema.org/ListItem">
                                <a href="about.html" class="breadcrambs-link" itemprop="item">
                                    <span itemprop="name">О компании</span>
        ...
        <header class="header slider-inner-page">
            <div class="container">
                <div class="swiper features-slider">
                    ...
                    <!-- Кнопки слайдера -->
                    <div class="header-buttons header-slider-buttons black-arrows">
